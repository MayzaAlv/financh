...
namespace financh_backend.Services
{
    public class EmailService
    {
        ...
        public void EnviarEmail(string[] destinatario, string assunto, int usuarioId,
            string[] usernames, string code)
        {
            Mensagem mensagem = new Mensagem(destinatario,
                assunto, usuarioId, usernames, code);
        ...
        private MimeMessage CriaCorpoDoEmail(Mensagem mensagem)
        {
            ...
            mensagemDeEmail.From.Add(new MailboxAddress("Financh",
